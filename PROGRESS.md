...
| **Merged** | #1 deploy hardening · #2 shift system · #3 CSS chrome · #4 standing orders · #5 backlog groom · #6 lane system · #7 artist pages |
| **Open PR** | **#10** Per-artist social cards (A1.2) — 60 PNGs |
...
- **#10 (open)** — per-artist social cards. 60 PNGs at 1200×630, wired into every page's
